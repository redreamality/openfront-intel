...
const contracts = [
  {
    ...
    facts: [
      ...
      ['v34.5 train saturation', /mid-to-late-game Train spawning.*300 to 500/is],
      ['v34.7 patch fixes', /creator codes.*clicks could stop responding/is],
      ['MIRV price ladder', /25 million.*15 million.*no global MIRV launch lockout/is],
  ...
  },
  {
    ...
    facts: [
      ...
      ['v34.5 train saturation', /中后期 Train 生成频率.*300.*500/is],
      ['v34.7 patch fixes', /创作者代码.*无法点击/is],
      ['MIRV price ladder', /25M.*15M.*没有全局 MIRV 发射锁定/is],
  ...
  },
  {
    ...
    facts: [
      ...
      ['v34.5 train saturation', /trains au milieu et en fin de partie.*300 à 500/is],
      ['v34.7 patch fixes', /codes de créateur.*tous les clics/is],
      ['MIRV price ladder', /25 millions.*15 millions.*Aucun verrou mondial/is],
  ...
  },
  {
    ...
    facts: [
      ...
      ['v34.5 train saturation', /Zugerzeugung im mittleren und späten Spiel.*300 auf 500/is],
      ['v34.7 patch fixes', /Creator-Codes.*keine Klicks/is],
      ['MIRV price ladder', /25 Millionen.*15 Millionen.*keine globale MIRV-Startsperre/is],
  ...
  },
  {
    ...
    facts: [
      ...
      ['v34.5 train saturation', /treingeneratie midden en laat.*300 naar 500/is],
      ['v34.7 patch fixes', /creatorcodes.*klikken helemaal niet meer/is],
      ['MIRV price ladder', /25 miljoen.*15 miljoen.*geen wereldwijde MIRV-lanceerblokkade/is],
