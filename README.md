...
- **战术攻略 4 篇 + 教程 4 篇（每种语言）** — FFA / Team / 海战 / 核威慑 / 新手第一局 / 快捷键 / 水上核弹 / Doomsday Clock。
- **版本笔记** — v24–v33 官方 Release 的整理与玩家向解读。
...
> 没有 `../OpenFrontIO/` 也能构建——脚本会回退到内置的 v33 数据快照。

## 内容维护

- [内容战略与滚动计划](docs/content-strategy.md)：当前战役、未来 6–8 周优先级、版本响应、多语节奏与停止规则。
- [每日执行账本](docs/content-loop.md)：当天编辑判断、计划项状态、信号、PR 与验证记录。
- [Search Console 工作流](docs/search-console-content-workflow.md)：私有搜索数据的拉取与机会分类。
- [内容差距调研](docs/content-gap-roadmap.md)：竞品和内容集群的历史研究基线。
