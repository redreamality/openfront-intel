...
| Production | `LF-COMMUNITY-ROLLING` | 本轮 `/guides/four-islands-team-coordination/` 已达到五语内容与来源门槛；合并即完成本次滚动主题并继续活动 | 下一轮重新从社区信号批准唯一意图；不得把四岛路线协同与地图策略、岛屿防守或团队角色换标题重复生产。 |
...
- 上游 `main` 游标：`709cb8ad756f190cc44094d5dd90b957b228faa4`；本轮已用 `git ls-remote` 核验。SAM 动态升级射程、地图预加载与外观 loadout 仍保持 Merged，不能越过正式 Release 边界。
