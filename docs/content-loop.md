...
| Production | `LF-COMMUNITY-ROLLING` | 本轮 `/guides/warship-veterancy/` 已达到五语内容与来源门槛；合并即完成本次滚动主题并继续活动 | 下一轮重新从社区信号批准唯一意图；不得把战舰经验、维修或港口队列换标题重复生产。 |
...
- 本轮战舰经验社区与 tag 核验：[`2026-08-26-warship-veterancy-community-source-pack.md`](research/2026-08-26-warship-veterancy-community-source-pack.md)。
