...
const seoCopy: Record<Lang, SeoCopy> = {
  en: {
    ...
    specialPaths: {
      ...
      'guides/warship-veterancy': 'OpenFront Warship Veterancy: Experience & How to Use Warships',
  ...
  fr: {
    ...
    special: {
      ...
      shortcuts: 'Référence des raccourcis OpenFront.io : commandes clavier et souris',
    ...
    specialPaths: {
      ...
      'guides/team-spawn-formation': 'Formation spawn en équipe OpenFront : rôles et espace',
  ...
  nl: {
    ...
    special: {
      ...
      shortcuts: 'OpenFront.io-sneltoetsenreferentie: toetsenbord- en muisbediening',
    ...
    specialPaths: {
      ...
      'guides/annexation-enclosure': 'OpenFront annexeren en omsluiten: timing en routes',
  ...
  de: {
    ...
    special: {
      ...
      shortcuts: 'OpenFront.io Tastenkürzel-Referenz: Tastatur- und Maussteuerung',
    ...
    specialPaths: {
      ...
      'guides/warship-veterancy': 'OpenFront Warship-Veterancy: Erfahrung & Reparatur',
      'guides/warship-fleet-decisions': 'OpenFront Warship-Flotte: Kauf, Einsatz und Rückzug',
      'guides/impossible-singleplayer': 'OpenFront Impossible: Einzelspieler-Medaille und Sieg',
  ...
  zh: {
    ...
    special: {
      ...
      shortcuts: 'OpenFront.io 快捷键速查表：键盘、鼠标与建造键',
    ...
    specialPaths: {
      ...
      'guides/impossible-singleplayer': 'OpenFront 单人 Impossible：奖章资格与获胜路线',
