...
The key adjustment is to preserve connected, capturable land and enough troops to recover during the warning. This is a territory-share threshold, not a geographic safe circle. Read the current [Doomsday Clock guide](/guides/doomsday-clock/) for the complete v33.1 rules and counterplay.
