---
title: "OpenFront land combat : attack, hold et counterattack"
description: "Utilisez ce guide de land combat OpenFront pour juger une attack, le terrain, les Defense Posts, le moment de hold et celui de counterattack."
pubDate: 2026-08-23
...
## Réponse directe : le land combat lit la frontière, pas seulement les totaux

Avoir plus de Troops ne garantit pas une percée. Avant une land combat attack, comparez la force réellement affectée, les Troops du défenseur par tile, le terrain, la couverture des Defense Posts, la taille territoriale et toute attaque opposée. Tenez la ligne quand la route est mauvaise ; renforcez seulement si les conditions justifient le coût, sinon arrêtez, changez de route ou faites un counterattack.
...
## Land combat attack et hold : checklist de frontière en dix secondes
...
Si le combat sert surtout a fermer une poche interieure, associez ce calcul a [Annexions et encerclement](/fr/guides/annexation-enclosure/) pour expliciter la derniere case, le credit et la reserve de repli.

Avant d'ouvrir ce combat contre une Nation Hard ou Impossible, utilisez [Pression des Nations](/fr/guides/nations-pressure/) pour vérifier l'éligibilité v34, la récompense exposée, le risque de riposte et le signal visible qui doit arrêter l'avance. Pour choisir la prochaine cible sur toute la carte, lisez aussi [Évaluer les menaces](/fr/guides/threat-assessment/).
