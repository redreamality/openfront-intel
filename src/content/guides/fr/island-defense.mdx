---
title: "OpenFront island defense : côte, landing et retraite"
description: "Cadre v0.33.12 d'island defense pour lire la coast, arrêter un landing et tenir une île ou une côte étroite contre les transports et Warships."
pubDate: 2026-08-29
...
## Réponse directe : que fait l'island defense sur la coast ?

Une île est sûre seulement si le prochain coast landing a une réponse visible. Gardez un noyau terrestre connecté, donnez un rôle clair au premier Port et placez le point de patrouille d'un Warship sur l'approche probable. Cette island defense distingue la côte atteignable de la simple eau visible.
...
## Lire la coast et la route de landing avant de dépenser
...
Quand l'île est déjà sûre mais ne touche toujours aucune terre gagnante, poursuivez avec le [guide tall contre wide](/fr/guides/tall-vs-wide/) afin de tester un point d'appui continental sans vider le noyau défendu.
...
Pour préparer l'autre côté du duel, utilisez le [guide des débarquements](/fr/guides/transport-landings/) afin de choisir la côte, répartir les vagues, placer l'écran de Warships, donner de la profondeur à la tête de pont et définir une règle d'annulation. Pour l'expérience et la réparation d'un escorteur, lisez le [guide Warship Veterancy](/fr/guides/warship-veterancy/).
