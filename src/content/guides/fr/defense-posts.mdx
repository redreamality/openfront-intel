---
title: "Postes de défense OpenFront : quand bâtir, portée et profondeur"
description: "Sachez quand un poste à 50 000 Gold achète du temps : rayon de 30 cases, construction de 50 ticks, profondeur et contournement."
pubDate: 2026-09-02
...
**Construisez maintenant** seulement si l'ennemi doit suivre une route prévisible, si le poste finit ses 50 ticks avant le contact et si le temps gagné finance une action précise. Sinon, gardez les 50 000 Gold mobiles ou reculez le poste.
...
## FAQ des postes de défense

- **Quand un poste à 50 000 Gold vaut-il le coût ?** Quand la route est prévisible, le poste finit avant le contact et le temps gagné protège une City, une Factory, un Port, un repli ou un débarquement précis. Un cercle vide ne rapporte rien.
- **Deux postes qui se chevauchent-ils leurs bonus ?** Non. La logique de l'attaque utilise un poste admissible ; le chevauchement ne crée pas un multiplicateur infini. Le second doit couvrir une autre entrée ou une ligne suivante.
- **Le poste arrête-t-il automatiquement les navires ?** Ne le supposez pas. La limite v0.33.12 vérifiée concerne le bonus terrestre ; la mer demande Port, Warship ou une règle navale publiée.
- **Que faire si l'ennemi contourne le cercle ?** Suivez l'objectif, déplacez les troupes et ne construisez un second poste que s'il achète du temps sur la nouvelle route.
