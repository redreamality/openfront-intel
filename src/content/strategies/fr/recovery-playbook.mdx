...
Pour décider en direct avant la rupture du front, utilisez le [guide du combat terrestre](/fr/guides/land-combat/). Après stabilisation, consultez les [fondamentaux économiques](/fr/strategies/economy-fundamentals/). Pour le résumé d'une première partie, revenez au [guide débutant](/fr/guides/first-match/).
