...
For spending after the border is stable, continue with [Economy Fundamentals](/strategies/economy-fundamentals/). For a first-match summary, use the [beginner guide](/guides/first-match/).
